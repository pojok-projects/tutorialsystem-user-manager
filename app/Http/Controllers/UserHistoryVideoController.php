...
class UserHistoryVideoController extends Controller
{
    ...
    {
        $result = $this->client->request('POST', $this->endpoint.'user/historyvideo/search', [
            'form_params' => [
                'query' => $q
            ]
        ]);
    ...
    {
    	$result = $this->client->request('GET', $this->endpoint.'user/historyvideo');
    ...
    public function create(Request $request)
    {
        ...
        if ($check_duplicate['response']) {
            ...
            $result = $this->client->request('POST', $this->endpoint.'user/historyvideo/store', [
                'form_params' => [
    ...
    {
        $result = $this->client->request('GET', $this->endpoint.'user/historyvideo/'.$id);
    ...
    { 
        ...
        if ($check_duplicate['response']) {
            ...
            $result = $this->client->request('POST', $this->endpoint.'user/historyvideo/update/'.$id, [
                'form_params' => [
                    'user_id' => $request->user_id,
                    'video_id' => $request->video_id,
                ]
    ...
    {
        $result = $this->client->request('POST', $this->endpoint.'user/historyvideo/delete/'.$id);
